<template>
  <nav class="nav" id="nav" aria-label="Navegação principal">
    ...
    <a href="https://api.whatsapp.com/send?phone=5512982112088&text=Ol%C3%A1%2C%20gostaria%20de%20fazer%20um%20or%C3%A7amento!" target="_blank" rel="noopener" class="nav-cta">
